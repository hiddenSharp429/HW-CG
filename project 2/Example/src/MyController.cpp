...
namespace tutorial {
	...
	void MyController::update(unsigned long elapsed_millis){
		...
		sensor_bottomleft[0] = 300;
		sensor_bottomleft[1] = 900;
		sensor_topright[0] = 600;
		sensor_topright[1] = 1200;
		sensor2_bottomleft[0] = 300;
		sensor2_bottomleft[1] = 1200;
		sensor2_topright[0] = 600;
		sensor2_topright[1] = 1500;
				...
				switch (first->_coordy) {
					case 0 : {
						if( (first->_position[0] < second->_position[0]-_winWidth+abs(second->_position[1]-first->_position[1])/1.2 ) || (first->_position[1]-_winHeight+100 > second->_position[1]) ) {
							first->_velocity = 0;
							first->_points++;
							first->_position[0] = second->_coordx*300+150-50;
							first->_position[1] = second->_coordy*300+150;
							second->_velocity = 0;
							second->_points--;
							second->_position[0] = second->_coordx*300+150+50;
							second->_position[1] = second->_coordy*300+150;
						}
						break;
					}
					case 1 : {
